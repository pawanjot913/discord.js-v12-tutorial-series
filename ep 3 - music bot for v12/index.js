...
client.on('message', async (message) => {
    ...
    if(command == "play") {
        ...
        if(!vc.channel.permissionsFor(client.user).has('CONNECT') || !vc.channel.permissionsFor(client.user).hconst Discord = require('discord.js');
const client = new Discord.Client();
const {prefix, token} = require("./config.json")
    ...
    if(command == "play") {
        ...
        if(!serverQueue) {
            ...
            try {
                ...
                playSong(message.guild, queueConst.songs[0])const Discord = require('discord.js');
const client = new Discord.Client();
const {prefix, token} = require("./config.json")
...
as('SPEAK')) return message.channel.send("I do not have permission!");
